...
class ResNet(nn.Module):
    ...
    def __init__(self,  block, layers, output_stride, BatchNorm, pretrained=True, in_c=3):
        ...
        self.pos_s32 = PA(512, 32)
        self.pos_s16 = PA(256, 32)
    ...
    def forward(self, input):
        ...
        out_32, out_s16, out_s8, out_s4 = self.pos_s32(x), self.pos_s16(low_level_feat4), self.pos_s8(low_level_feat3), self.pos_s4(low_level_feat2)
        return out_32, out_s16, out_s8, out_s4
